...
public class NotificationAdmain extends ContextWrapper {

    public static final String CHANNEL_NAME = "channel_name_1";
    public static final String NOTIFICATION_CHANEEL_ID = "channel_1";
...
//		cBuilder = new NotificationCompat.Builder(mContext);
    ...
    public void createNotificationChannel(){
        NotificationChannel channel = new NotificationChannel(NOTIFICATION_CHANEEL_ID, CHANNEL_NAME, NotificationManager.IMPORTANCE_HIGH);
    ...
    public Notification.Builder getChannelNotification(Intent intent,int smallIcon, String ticker, String title, String msg){
        Notification.Builder builder =  new Notification.Builder(getApplicationContext(), NOTIFICATION_CHANEEL_ID);
/*        builder.setContentTitle(title)
    ...
    public NotificationCompat.Builder getNotification_25(Intent intent,int smallIcon, String ticker, String title, String msg){
    ...
    //生成 notfcation
    public void createNotification(Intent intent,int smallIcon, String ticker, String title, String msg){
        if (Build.VERSION.SDK_INT>=26){
            createNotificationChannel();
            Notification notification = getChannelNotification(intent,smallIcon,ticker,title, msg).build();
            getManager().notify(notificationId,notification);
        }else{
            Notification notification = getNotification_25( intent,smallIcon,ticker,title, msg).build();
            getManager().notify(notificationId,notification);
        }
    }
	 ...
	 * @param msg
	 */
	public void normal_notification(Intent intent, int smallIcon, String ticker, String title, String msg) {

		//setCompatBuilder(intent, smallIcon, ticker, title, msg);
        createNotification (intent, smallIcon, ticker, title, msg);
//		sent();
	}
...
/*
	 ...
	 * @param msg
	 */
	public void progress_notification(Intent intent, int smallIcon, String ticker, String title, String msg) {
