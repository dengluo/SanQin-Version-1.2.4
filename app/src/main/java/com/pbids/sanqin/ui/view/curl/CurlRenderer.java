...
public class CurlRenderer implements GLSurfaceView.Renderer {
	...
	// Constants for changing view_donate_records mode.
	...
	/**
	 * Translates screen coordinates into view_donate_records coordinates.
	 */
	...
	private void updatePageRects() {
		if (mViewRect.width() == 0 || mViewRect.height() == 0) {
			...
			int bitmapH = (int) ((mPageRectRight.height() * mViewportHeight) / mViewRect
					.height());
//			int bitmapW =mViewportWidth;
//			int bitmapH =mViewportHeight;
