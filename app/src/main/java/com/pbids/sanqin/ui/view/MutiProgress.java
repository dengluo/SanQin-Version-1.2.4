...
//		mCanvas.drawLine(nodeRadius, mHeight/2, mWidth-nodeRadius, mHeight/2, mPaint);  //线段2端去掉nodeRadius
		if(currNodeNO>0){
			...
			mCanvas.drawLine(nodeRadius, mHeight/2, nodes.get(0).mPoint.x + nodeRadius, nodes.get(0).mPoint.y + nodeRadius, mPaint);  //线段2端去掉nodeRadius
		}
		//后半截线段
		...
		if (currNodeNO > 0) {
			...
			mCanvas.drawLine(nodes.get(0).mPoint.x + nodeRadius, nodes.get(0).mPoint.y + nodeRadius, mWidth - nodeRadius, mHeight / 2, mPaint);  //线段2端去掉nodeRadius
		}
	}
