...
import com.pbids.sanqin.contact.activity.UserProfileSettingActivity;
import com.pbids.sanqin.model.entity.SettingTemplate;
import com.pbids.sanqin.model.entity.SettingType;
import com.pbids.sanqin.ui.adapter.SettingsAdapter;
...
//        items.insert(new SettingTemplate(TAG_HEAD, SettingType.TYPE_HEAD));
...
//        items.insert(new SettingTemplate(TAG_NOTIFICATION_STYLE, getString(R.string.notification_folded), SettingType.TYPE_TOGGLE,
//                UserPreferences.getNotificationFoldedToggle()));
//        items.insert(SettingTemplate.addLine());
//        disturbItem = new SettingTemplate(TAG_NO_DISTURBE, getString(R.string.no_disturb), noDisturbTime); //免打设置有buf 设置后没有及时更新结果
//        items.insert(disturbItem);
        items.add(SettingTemplate.addLine());
      /*  items.insert(new SettingTemplate(TAG_MULTIPORT_PUSH, getString(R.string.multiport_push), SettingType.TYPE_TOGGLE,
                !NIMClient.getService(SettingsService.class).isMultiportPushOpen()));*/

//        items.insert(SettingTemplate.makeSeperator());
    ...
    /*    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            items.insert(new SettingTemplate(TAG_NRTC_SETTINGS, getString(R.string.nrtc_settings)));
            items.insert(SettingTemplate.addLine());
            items.insert(new SettingTemplate(TAG_NRTC_NET_DETECT, "音视频通话网络探测"));
            items.insert(SettingTemplate.makeSeperator());
        }*/

//        items.insert(new SettingTemplate(TAG_MSG_IGNORE, "过滤通知",
...
//        items.insert(clearIndexItem);

//        items.insert(SettingTemplate.makeSeperator());

//        items.insert(new SettingTemplate(TAG_CUSTOM_NOTIFY, getString(R.string.custom_notification)));
//        items.insert(SettingTemplate.addLine());
//        items.insert(new SettingTemplate(TAG_JS_BRIDGE, getString(R.string.js_bridge_demonstration)));
//        items.insert(SettingTemplate.makeSeperator());

        /*if (NIMRedPacketClient.isEnable()) {
            items.insert(new SettingTemplate(TAG_JRMFWAllET, "我的钱包"));
            items.insert(SettingTemplate.makeSeperator());
        }*/

//        items.insert(new SettingTemplate(TAG_ABOUT, getString(R.string.setting_about)));
