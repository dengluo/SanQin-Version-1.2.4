...
import com.pbids.sanqin.ui.recyclerview.structure.GroupStructure;
...
public abstract class GroupedRecyclerViewAdapter
    ...
    public int judgeType(int position) {
        ...
        throw new IndexOutOfBoundsException("can't determine the item_zq_choose_group type of the position." +
                "position = " + position + ",item_zq_choose_group count = " + getItemCount());
    }
