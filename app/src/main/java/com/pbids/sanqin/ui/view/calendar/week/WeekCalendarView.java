 ...
 */
public class WeekCalendarView extends NoScrollViewPager implements OnWeekClickListener {
    ...
    private OnPageChangeListener mOnPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(final int position) {
            ...
            if (weekView != null) {
                if (mOnCalendarClickListener != null) {
                    mOnCalendarClickListener.onPageChange(weekView.getSelectYear(), weekView.getSelectMonth(), weekView.getSelectDay(),position);
                }
