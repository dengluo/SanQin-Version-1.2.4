...
//        setCurrentItem(mMonthAdapter.getMonthCount() / 2, false);
        setCurrentItem(mMonthAdapter.getMonthCount(), false);
    }
    ...
    private OnPageChangeListener mOnPageChangeListener = new OnPageChangeListener() {
        ...
        public void onPageSelected(final int position) {
            ...
            if (monthView != null) {
                ...
                if (mOnCalendarClickListener != null) {
                    mOnCalendarClickListener.onPageChange(monthView.getSelectYear(), monthView.getSelectMonth(), monthView.getSelectDay(),position);
                }
            } else {
