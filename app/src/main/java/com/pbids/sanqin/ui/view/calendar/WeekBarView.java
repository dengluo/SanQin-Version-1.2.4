package com.pbids.sanqin.ui.view.calendar;
...
public class WeekBarView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mWeekTextColor = array.getColor(R.styleable.WeekBarView_week_text_color, Color.parseColor("#A62A0E"));
        mWeekSize = array.getInteger(R.styleable.WeekBarView_week_text_size, 16);
