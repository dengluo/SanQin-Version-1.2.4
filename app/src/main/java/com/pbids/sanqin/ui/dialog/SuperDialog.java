package com.pbids.sanqin.ui.dialog;
...
public class SuperDialog extends Dialog {
    ...
    private int titleStyle ,contentStyle,buttonStyle,imageStyle;
    ...
    private void initTitleView(LinearLayout viewRoot) {
        ...
        if(titleStyle>0){
            titleView.setTextAppearance(context.getApplicationContext(),titleStyle);
        }
    ...
    private void initImageView(ViewGroup viewRoot) {
        ...
        //LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(context.getResources().getDimension(R.dimen.dp_85), context.getResources().getDimension(R.dimen.dp_85));
        layoutParams.setMargins(dp2px(15), dp2px(5), dp2px(15), dp2px(5));
    ...
    private void initContentView(ViewGroup viewRoot) {
        ...
        if(contentStyle>0){
            contentView.setTextAppearance(context.getApplicationContext(),contentStyle);
        }
        viewRoot.addView(contentView);
    }

    //设置样式
    public void setTitleViewStyle(int styleId){
        titleStyle = styleId;
    }
    public void setContentViewStyle(int styleId){
        contentStyle = styleId;
    }
    public void setImageViewStyle(int styleId){
        imageStyle = styleId;
    }
    public void setButtonViewStyle(int styleId){
        buttonStyle = styleId;
    }
