package com.pbids.sanqin.ui.recyclerview.swipe.adapters;
...
public abstract class BaseSwipeAdapter extends BaseAdapter implements SwipeItemMangerInterface, SwipeAdapterInterface {
    ...
    /**
     * return the {@link SwipeLayout} resource id, int the view_donate_records item.
     * @param position
     * @return
     */
    ...
    /**
     * generate a new view_donate_records item.
    ...
    /**
     * fill values or bind listeners to the view_donate_records.
     * @param position
     * @param convertView
     */
