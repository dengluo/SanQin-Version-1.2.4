...
public class NimSDKOptionConfig {
    ...
    public static SDKOptions getSDKOptions(Context context) {
        ...
        options.sdkStorageRootPath = getAppCacheDir(context) + "/sanqin"; // 可以不设置，那么将采用默认路径
...
//        options.initAsync =
    ...
    private static void initStatusBarNotificationConfig(SDKOptions options) {
        ...
        userConfig.notificationSmallIconId = R.drawable.app_logo;
        userConfig.notificationSound = "android.resource://com.pbids.sanqin/raw/msg";
        userConfig.notificationEntrance = BootPageActivity.class;
...
//        config.notificationEntrance = HomePageActivity.class;
        config.notificationEntrance = BootPageActivity.class;
        ...
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.pbids.sanqin/raw/msg";
