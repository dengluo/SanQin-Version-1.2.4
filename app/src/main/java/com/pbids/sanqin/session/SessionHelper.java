package com.pbids.sanqin.session;
...
import com.pbids.sanqin.contact.activity.RobotProfileActivity;
import com.pbids.sanqin.contact.activity.TeamUserProfileActivity;
import com.pbids.sanqin.contact.activity.UserProfileActivity;
//import com.pbids.sanqin.redpacket.NIMRedPacketClient;
import com.pbids.sanqin.session.action.AVChatAction;
import com.pbids.sanqin.session.action.FileAction;
import com.pbids.sanqin.session.action.GuessAction;
import com.pbids.sanqin.session.action.RTSAction;
import com.pbids.sanqin.session.action.RedPacketAction;
import com.pbids.sanqin.session.action.SnapChatAction;
import com.pbids.sanqin.session.action.TeamAVChatAction;
import com.pbids.sanqin.session.action.TipAction;
import com.pbids.sanqin.session.activity.MessageHistoryActivity;
import com.pbids.sanqin.session.activity.MessageInfoActivity;
import com.pbids.sanqin.session.extension.CustomAttachParser;
import com.pbids.sanqin.session.extension.CustomAttachment;
...
import com.pbids.sanqin.session.search.SearchMessageActivity;
import com.pbids.sanqin.session.viewholder.MsgViewHolderAVChat;
import com.pbids.sanqin.session.viewholder.MsgViewHolderDefCustom;
import com.pbids.sanqin.session.viewholder.MsgViewHolderFile;
import com.pbids.sanqin.session.viewholder.MsgViewHolderGuess;
import com.pbids.sanqin.session.viewholder.MsgViewHolderOpenRedPacket;
import com.pbids.sanqin.session.viewholder.MsgViewHolderRTS;
import com.pbids.sanqin.session.viewholder.MsgViewHolderRedPacket;
import com.pbids.sanqin.session.viewholder.MsgViewHolderSnapChat;
import com.pbids.sanqin.session.viewholder.MsgViewHolderSticker;
import com.pbids.sanqin.session.viewholder.MsgViewHolderTip;
        ...
        SessionEventListener listener = new SessionEventListener() {
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                if(context instanceof TeamMessageActivity){
                    //群资料
                    TeamUserProfileActivity.start(context, message.getFromAccount());
                }else {
