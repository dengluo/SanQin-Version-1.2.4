 ...
 */
public class TeamUserProfileActivity extends UI {

    private static final String TAG = TeamUserProfileActivity.class.getSimpleName();
    ...
    public static void start(Context context, String account) {
        ...
        intent.setClass(context, TeamUserProfileActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.team_user_profile_activity);
    ...
    private void findViews() {
        //个性签名
        userSingTure = findView(R.id.user_signature);
        ...
        aliasLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UserProfileEditItemActivity.startActivity(TeamUserProfileActivity.this, UserConstant.KEY_ALIAS, account);
            }
        });
    }
    ...
    private void initActionbar() {
        ...
        toolbarView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                UserProfileSettingActivity.start(TeamUserProfileActivity.this, account);
            }
        });
...
//        blackSwitch = addToggleItemView(KEY_BLACK_LIST, R.string.black_list, black);
	...
	private void updateUserExtend( ) {
		...
		this.userBusinessCooperation.setVisibility(View.INVISIBLE);
    ...
    private void updateUserInfoView() {
        ...
        userSingTure.setText(userInfo.getSignature());
		//更新用户扩展信息
		updateUserExtend();
...
/*        if (userInfo.getGenderEnum() == GenderEnum.MALE) {
    ...
    private SwitchButton.OnChangedListener onChangedListener = new SwitchButton.OnChangedListener() {
        ...
        public void OnChanged(View v, final boolean checkState) {
            ...
            if (!NetworkUtil.isNetAvailable(TeamUserProfileActivity.this)) {
                Toast.makeText(TeamUserProfileActivity.this, R.string.network_is_not_available, Toast.LENGTH_SHORT).show();
            ...
            if (key.equals(KEY_BLACK_LIST)) {
                if (checkState) {
                    NIMClient.getService(FriendService.class).addToBlackList(account).setCallback(new RequestCallback<Void>() {
                        ...
                        public void onSuccess(Void param) {
                            Toast.makeText(TeamUserProfileActivity.this, "加入黑名单成功", Toast.LENGTH_SHORT).show();
                        }
                        ...
                        public void onFailed(int code) {
                            if (code == 408) {
                                ...
                                Toast.makeText(TeamUserProfileActivity.this, "on failed：" + code, Toast.LENGTH_SHORT).show();
                            }
                            updateStateMap(!checkState, key);
                            blackSwitch.setCheck(!checkState);
                        }
                    ...
                    NIMClient.getService(FriendService.class).removeFromBlackList(account).setCallback(new RequestCallback<Void>() {
                        @Override
                        public void onSuccess(Void param) {
                            Toast.makeText(TeamUserProfileActivity.this, "移除黑名单成功", Toast.LENGTH_SHORT).show();
                        }
                ...
                NIMClient.getService(FriendService.class).setMessageNotify(account, checkState).setCallback(new RequestCallback<Void>() {
                    ...
                    public void onSuccess(Void param) {
                        if (checkState) {
                            Toast.makeText(TeamUserProfileActivity.this, "开启消息提醒成功", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(TeamUserProfileActivity.this, "关闭消息提醒成功", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void doAddFriend(String msg, boolean addDirectly) {
        ...
        if (!TextUtils.isEmpty(account) && account.equals(DemoCache.getAccount())) {
            Toast.makeText(TeamUserProfileActivity.this, "不能加自己为好友", Toast.LENGTH_SHORT).show();
            return;
        }
                ...
                .setCallback(new RequestCallback<Void>() {
                    ...
                    public void onSuccess(Void param) {
                        ...
                        if (VerifyType.DIRECT_ADD == verifyType) {
                            Toast.makeText(TeamUserProfileActivity.this, "添加好友成功", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(TeamUserProfileActivity.this, "添加好友请求发送成功", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onFailed(int code) {
                        DialogMaker.dismissProgressDialog();
                        if (code == 408) {
                            Toast.makeText(TeamUserProfileActivity.this, R.string.network_is_not_available, Toast
                                    .LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(TeamUserProfileActivity.this, "on failed:" + code, Toast
                                    .LENGTH_SHORT).show();
                        }
                    }
        ...
        EasyAlertDialog dialog = EasyAlertDialogHelper.createOkCancelDiolag(this, getString(R.string.remove_friend),
                ...
                new EasyAlertDialogHelper.OnDialogActionListener() {
                    ...
                    public void doOkAction() {
                        DialogMaker.showProgressDialog(TeamUserProfileActivity.this, "", true);
                        NIMClient.getService(FriendService.class).deleteFriend(account).setCallback(new RequestCallback<Void>() {
                            @Override
                            public void onSuccess(Void param) {
                                DialogMaker.dismissProgressDialog();
                                Toast.makeText(TeamUserProfileActivity.this, R.string.remove_friend_success, Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent();
