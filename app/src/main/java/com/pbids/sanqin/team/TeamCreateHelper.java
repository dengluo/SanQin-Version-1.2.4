...
public class TeamCreateHelper{
     ...
     * 创建讨论组
     */
    public static void createNormalTeam(final Context context, String teamName, List<String> memberAccounts, final boolean isNeedBack, final RequestCallback<CreateTeamResult> callback) {
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, TeamTypeEnum.Normal, "",
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onSuccess(CreateTeamResult result) {
                        ...
                        if (isNeedBack) {
                            SessionHelper.startTeamSession(context, result.getTeam().getId(), HomePageActivity.class, null); // 进入创建的群
                        } else {
     ...
     * 创建高级群
     */
    public static void createAdvancedTeam(final Context context, List<String> memberAccounts, String teamName, final SuccessCallBack successCallBack) {
        ...
        NIMClient.getService(TeamService.class).createTeam(fields, type, "",
                ...
                new RequestCallback<CreateTeamResult>() {
                    ...
                    public void onSuccess(CreateTeamResult result) {
                        Log.i(TAG, "create team success, team id =" + result.getTeam().getId() + ", now begin to update property...");
                        onCreateSuccess(context, result);
                        successCallBack.successTeam(result);
                    }
                    ...
                    public void onFailed(int code) {
                        ...
                        Log.e(TAG, "create team error: " + code);
                        successCallBack.failedTeam(tip);
                    }
    ...
    public interface SuccessCallBack{
        void successTeam(CreateTeamResult createTeamResult);
        void failedTeam(String tips);
    }
}
