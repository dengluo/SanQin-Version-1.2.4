...
public class AdvancedTeamAnnounceActivity extends UI implements TAdapterDelegate {
    ...
    private final static String CEATOR = "ceator";
    ...
    public static void start(Activity activity, String teamId, String announceId, String icon, String creator, String account) {
        Intent intent = new Intent();
        intent.setClass(activity, AdvancedTeamAnnounceActivity.class);
        intent.putExtra(EXTRA_TID, teamId);
        intent.putExtra(ICONURL, icon);
        intent.putExtra(CEATOR, creator);
    ...
    private void parseIntentData() {
        ...
        creator = getIntent().getStringExtra(CEATOR);
    ...
    private void setAnnounceItem() {
        ...
        if(list.size()>0){
            ...
            announcement.setIconUrl(iconUrl);
            list.clear();
