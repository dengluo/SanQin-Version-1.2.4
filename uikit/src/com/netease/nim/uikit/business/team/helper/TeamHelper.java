...
public class TeamHelper {
    ...
    public static VerifyTypeEnum getVerifyTypeEnum(int name) {
        VerifyTypeEnum type = null;
    ...
    // 获取提醒类型
    public static TeamMessageNotifyTypeEnum getNotifyType(int name) {
        TeamMessageNotifyTypeEnum type = null;
        if (name==0) {
            type = TeamMessageNotifyTypeEnum.All;
        } else if (name==1) {
    ...
    // 获取邀请他人类型
    public static TeamInviteModeEnum getInviteModeEnum(int name) {
        TeamInviteModeEnum type = null;
    ...
    // 获取群资料修改类型
    public static TeamUpdateModeEnum getUpdateModeEnum(int name) {
        TeamUpdateModeEnum type = null;
    ...
    // 获取被邀请人身份类型
    public static TeamBeInviteModeEnum getBeInvitedModeEnum(int name) {
        TeamBeInviteModeEnum type = null;
