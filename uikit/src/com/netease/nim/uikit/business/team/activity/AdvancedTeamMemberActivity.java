...
public class AdvancedTeamMemberActivity extends UI implements TAdapterDelegate,
    ...
    public static final String MANAGERDATA = "managerData" ;
    ...
    private boolean isManangerData = false;

    public static void startActivityForResult(Activity context, String tid, int resCode, boolean isManagerData) {
        Intent intent = new Intent();
        intent.putExtra(EXTRA_ID, tid);
        intent.putExtra(MANAGERDATA, isManagerData);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isManangerData) options.titleId = R.string.team_admin;
    ...
    private void parseIntentData() {
        ...
        isManangerData = getIntent().getBooleanExtra(MANAGERDATA,false);
    }
