...
public abstract class PickImageAction extends BaseAction {
    ...
    protected PickImageAction(int iconResId, int titleId, boolean multiSelect, String type) {
        super(iconResId, titleId);
        this.multiSelect = multiSelect;
        this.type = type;
    }
    ...
    public void onClick() {
        ...
        showSelector(getTitleId(), requestCode, multiSelect, tempFile(),type);
    }
     ...
     * 打开图片选择器
     */
    private void showSelector(int titleId, final int requestCode, final boolean multiSelect, final String outPath, String type) {
        PickImageHelper.PickImageOption option = new PickImageHelper.PickImageOption();
        option.titleResId = titleId;
        option.multiSelect = multiSelect;
        option.multiSelectMaxCount = PICK_IMAGE_COUNT;
        ...
        PickImageHelper.pickImage(getActivity(), requestCode, option, type);
    }
