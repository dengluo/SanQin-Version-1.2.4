...
//        emptyHint.setHint("还没有会话，在通讯录中找个人聊聊吧！");
    ...
    private UnreadCountProvice unreadCountProvice;
    public void setUnreadCountProvice(UnreadCountProvice unreadCountProvice) {
        this.unreadCountProvice = unreadCountProvice;
    }
    //更新红点事件
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void refreshUnreadsEvent(RefreshUnreadCountEvent evt ) {
        refreshMessages(true);
    }
    ...
    private void refreshMessages(boolean unreadChanged) {
        ...
        if (unreadChanged) {
            ...
            //自定更新点数量
            if (this.unreadCountProvice != null) {
                unreadNum += this.unreadCountProvice.getCount();
            }
