 ...
 * @author huangjun
 */
public class LivRecyclerviewIndex {
    ...
    public LivRecyclerviewIndex(RecyclerView contactsListView, LetterIndexView letterIndexView, TextView letterHit, ImageView
            imgBackLetter,
